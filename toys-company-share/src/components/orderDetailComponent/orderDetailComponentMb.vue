      ...
      <div class="orderInfo">
        <div class="one">
          <div class="left">
            ...
            <div class="values">{{ orderInfo.createdOn.slice(0, 10) }}</div>
          </div>
          <div class="right">
              ...
              <div class="productInformation">
                ...
                <div class="infoBox">
                  ...
                  <div class="item">
                    ...
                    <div class="content">
                      <span
                        >{{ myShoppingCartLang.productSpecification }}：</span
                      >
                      <span
                    ...
                    <div class="content">
                      <span
                        >{{ myShoppingCartLang.packageSpecification }}：</span
                      >
                      <span
                        >{{ scope.row.innerLenth }} x
                        {{ scope.row.innerWidth }} x
                  ...
                  <div class="item top">
                    <div class="content" v-if="shareInfo.isShowPrice">
                    ...
                    <div class="content">
                      <span>{{ myShoppingCartLang.totalVolume }}：</span>
                      <span class="red_color"
                        >{{ scope.row.totalProductStere }}cbm
                        {{ scope.row.totalProductFeet }}cuft</span
                      >
                    </div>
                    <div class="content" v-if="shareInfo.isShowPrice">
                      <span>{{ myShoppingCartLang.totalAmount }}：</span>
                      <span class="red_color active"
                        >{{ scope.row.currencyType
