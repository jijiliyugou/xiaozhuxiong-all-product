      ...
      <div class="showTip">
        ...
        <div class="bottomInput">
          ...
          <!-- <div class="inputItem" v-show="isShowAdvancedSearch">
            <div class="searchBtn">
              <el-button type="warning" @click="search" icon="el-icon-search" size="mini">{{
                homeLang.search
              }}</el-button>
            </div>
          </div> -->
          ...
          <div class="consistencyWrapBox" v-show="!isShowAdvancedSearch">
            <div class="consistencyBox">
              ...
              <div class="right">
                ...
                <div class="itemInput" style="alignItem: center;">
                  <div class="title">
...
export default {
  ...
  methods: {
    ...
    search() {
      if (this.$route.path.includes("/index/product"))
        this.$root.eventHub.$emit("resetProducts", true);
  ...
  mounted() {
    ...
    this.$root.eventHub.$on("resetSearch", () => {
