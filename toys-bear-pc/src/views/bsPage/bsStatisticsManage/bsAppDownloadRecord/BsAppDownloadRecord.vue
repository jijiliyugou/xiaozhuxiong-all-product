 ...
 * @FilePath: \projectd:\LittleBearPC\toys-bear-pc\src\views\bsPage\bsStatisticsManage\bsAppDownloadRecord\BsAppDownloadRecord.vue
 * @LastEditTime: 2021-06-24 10:54:20
 * @LastEditors: sueRimn
 * @Descripttion: 
 * @version: 1.0.0
-->
<template>
  <div class="bsAppDownloadRecord">
    <bar-chart
      :title="title"
      :data="data"
      :defaultValue="defaultValue"
      charId="bsAppDownloadRecord"
      ref="bsAppDownloadRecordChart"
    ></bar-chart>
    <div class="title">
      <div class="left">下载记录({{ totalCount }})</div>
    </div>
...
export default {
  ...
  watch: {
    $route(to) {
      if (to.path == this.$route.path) {
        this.$refs.bsAppDownloadRecordChart.drawLine(true);
      }
    }
  },
  methods: {
  ...
  mounted() {
    this.$refs.bsAppDownloadRecordChart.drawLine();
  },
  created() {
    this.getTableDataList();
  }
