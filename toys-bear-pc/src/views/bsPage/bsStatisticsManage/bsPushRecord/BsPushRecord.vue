 ...
 * @FilePath: \projectd:\LittleBearPC\toys-bear-pc\src\views\bsPage\bsStatisticsManage\bsPushRecord\BsPushRecord.vue
 * @LastEditTime: 2021-06-24 10:55:43
 * @LastEditors: sueRimn
 * @Descripttion: 
 * @version: 1.0.0
-->
<template>
  <div class="bsPushRecord">
    <bar-chart
      :title="title"
      :data="data"
      :defaultValue="defaultValue"
      charId="bsPushRecord"
      ref="bsPushRecordChart"
    ></bar-chart>
    <div class="title">
      <div class="left">推送列表({{ totalCount }})</div>
    </div>
