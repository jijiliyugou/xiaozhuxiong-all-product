 ...
 * @FilePath: \projectd:\LittleBearPC\toys-bear-pc\src\views\bsPage\bsStatisticsManage\bsProductQueryRecord\BsProductQueryRecord.vue
 * @LastEditTime: 2021-06-24 10:54:56
 * @LastEditors: sueRimn
 * @Descripttion: 
 * @version: 1.0.0
-->
<template>
  <div class="bsProductQueryRecord">
    <bar-chart
      :title="title"
      :data="data"
      :defaultValue="defaultValue"
      charId="bsProductQueryRecord"
      ref="bsProductQueryRecordChart"
    ></bar-chart>
    <div class="title">
      <div class="left">公司列表({{ totalCount }})</div>
    </div>
...
export default {
  ...
  watch: {
    $route(to) {
      if (to.path == this.$route.path) {
        this.$refs.bsProductQueryRecordChart.drawLine(true);
      }
    }
  },
  methods: {
    ...
    async getTableDataList() {
      const fd = {
        ...
        companyKeyword: this.searchForm.keyword
  ...
  mounted() {
    this.$refs.bsProductQueryRecordChart.drawLine();
  },
  created() {
    this.getTableDataList();
  }
