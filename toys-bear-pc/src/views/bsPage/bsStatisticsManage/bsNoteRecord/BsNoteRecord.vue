 ...
 * @FilePath: \projectd:\LittleBearPC\toys-bear-pc\src\views\bsPage\bsStatisticsManage\bsNoteRecord\bsNoteRecord.vue
 * @LastEditTime: 2021-06-24 10:55:54
 * @LastEditors: sueRimn
 * @Descripttion: 
 * @version: 1.0.0
-->
<template>
  <div class="bsNoteRecord">
    <bar-chart
      :title="title"
      :data="data"
      :defaultValue="defaultValue"
      charId="bsNoteRecord"
      ref="bsNoteRecordChart"
    ></bar-chart>
    <div class="title">
      <div class="left">短信列表({{ totalCount }})</div>
    </div>
...
export default {
  ...
  watch: {
    $route(to) {
      if (to.path == this.$route.path) {
        this.$refs.bsNoteRecordChart.drawLine(true);
      }
    }
  },
  methods: {
  ...
  mounted() {
    this.$refs.bsNoteRecordChart.drawLine();
  },
  created() {
    this.getTableDataList();
  }
