 ...
 * @FilePath: \projectd:\LittleBearPC\toys-bear-pc\src\components\public\barChart.vue
 * @LastEditTime: 2021-06-25 18:01:18
 * @LastEditors: sueRimn
 * @Descripttion: 
 * @version: 1.0.0
-->
<template>
  <div class="barChart">
    ...
    <div class="total_chart" :id="charId"></div>
  </div>
</template>
<script>
/**
 ...
 * @property {Array} charId 柱形图ID
 * @property {Array} data 柱形图数据
 * @property {String} title 柱形图标题
...
export default {
  ...
  methods: {
    //生成chart
    drawLine(flag) {
      var chartDom = document.getElementById(this.charId);
